...
if __name__ == "__main__":
    pdb_id = "2m10"  # You can change this to analyze different proteins
    radius = 8.0  # You can adjust this value
    tau_mean = 0.3  # You can adjust this value or set to None to use default

    te_matrix, segments = analyze_secondary_structure_transfer_entropy(pdb_id, radius, tau_mean)
